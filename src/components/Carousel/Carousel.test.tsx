...
const testList = () => range(0, 16).map((i) => <div key={i} data-testid={`test-${i}`} />)
...
test('should correctly chunk and wrap groups for seamless infinite scrolling with small viewport size', () => {
    ...
    expect(dataTestIds).toEqual([
        'test-0', 'test-1', 'test-2', 'test-3', 'test-4', 'test-5', 'test-6', 'test-7', 'test-8', 'test-9', 'test-10', 'test-11', 'test-12', 'test-13', 'test-14', 'test-15', 'test-0', 'test-1', 
      ]);
})
...
test('should correctly chunk and wrap groups for seamless infinite scrolling with medium viewport size', () => {
    ...
    const dataTestIds = divs.map(div => div.getAttribute('data-testid'));
    expect(dataTestIds).toEqual([
        'test-0', 'test-1', 'test-2', 'test-3', 'test-4', 'test-5', 'test-6', 'test-7', 'test-8', 'test-9', 'test-10', 'test-11', 'test-12', 'test-13', 'test-14', 'test-15', 'test-0', 'test-1', 'test-2', 'test-3' 
      ]);
})
...
test('should correctly chunk and wrap groups for seamless infinite scrolling with large viewport size', () => {
    ...
    const dataTestIds = divs.map(div => div.getAttribute('data-testid'));
    expect(dataTestIds).toEqual([
        'test-0', 'test-1', 'test-2', 'test-3', 'test-4', 'test-5', 'test-6', 'test-7', 'test-8', 'test-9', 'test-10', 'test-11', 'test-12', 'test-13', 'test-14', 'test-15', 'test-0', 'test-1', 'test-2', 'test-3',  'test-4', 'test-5', 'test-6', 'test-7' 
      ]);
})
...
test('clicking pagePrevious button increments focusedGroup', async () => {
    ...
    const { getByTestId, getAllByTestId } = render(<Carousel listItems={testList()}/>)
    ...
    expect(dataTestIds2).toEqual([
        'test-14', 'test-15', 'test-0', 'test-1', 'test-2', 'test-3', 'test-4', 'test-5', 'test-6', 'test-7', 'test-8', 'test-9', 'test-10', 'test-11', 'test-12', 'test-13', 'test-14', 'test-15',
    ]);
...
test('clicking pageNext button increments focusedGroup', async () => {
    ...
    // Expect next 
    expect(dataTestIds2).toEqual([
        'test-2', 'test-3', 'test-4', 'test-5', 'test-6', 'test-7', 'test-8', 'test-9', 'test-10', 'test-11', 'test-12', 'test-13', 'test-14', 'test-15', 'test-0', 'test-1', 'test-2', 'test-3',
    ]);
